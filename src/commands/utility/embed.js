...
module.exports = {
  ...
  async execute(interaction) {
    ...
    if (!title && !description && !image) return interaction.reply({ embeds: [Embed.error(t(gid, 'util.embed.need_content'))], ephemeral: true });
    ...
    catch (e) { return interaction.reply({ embeds: [Embed.error(t(gid, 'util.embed.failed', { error: e.message }))], ephemeral: true }); }
    return interaction.reply({ embeds: [Embed.success(t(gid, 'util.embed.sent', { channel: channel.toString() }))], ephemeral: true });
  },
};
